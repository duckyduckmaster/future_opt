...
typedef struct _enc__active__assertFalse_Main_t _enc__active__assertFalse_Main_t;
...
extern pony_type_t _enc__active__assertFalse_Main_type;
...
{
  _MSG_DUMMY__ = 1024,
  _ENC__FUT_MSG__assertFalse_Main_init,
  _ENC__FUT_MSG__assertFalse_Main_await,
  _ENC__FUT_MSG__assertFalse_Main_suspend,
  _ENC__FUT_MSG__assertFalse_Main_main,
  ...
  _ENC__ONEWAY_MSG__assertFalse_Main_init,
  _ENC__ONEWAY_MSG__assertFalse_Main_await,
  _ENC__ONEWAY_MSG__assertFalse_Main_suspend,
  _ENC__ONEWAY_MSG__assertFalse_Main_main,
...
typedef struct _enc__fut_msg__assertFalse_Main_init_t _enc__fut_msg__assertFalse_Main_init_t;


typedef struct _enc__oneway_msg__assertFalse_Main_init_t _enc__oneway_msg__assertFalse_Main_init_t;


typedef struct _enc__fut_msg__assertFalse_Main_await_t _enc__fut_msg__assertFalse_Main_await_t;


typedef struct _enc__oneway_msg__assertFalse_Main_await_t _enc__oneway_msg__assertFalse_Main_await_t;


typedef struct _enc__fut_msg__assertFalse_Main_suspend_t _enc__fut_msg__assertFalse_Main_suspend_t;


typedef struct _enc__oneway_msg__assertFalse_Main_suspend_t _enc__oneway_msg__assertFalse_Main_suspend_t;


typedef struct _enc__fut_msg__assertFalse_Main_main_t _enc__fut_msg__assertFalse_Main_main_t;


typedef struct _enc__oneway_msg__assertFalse_Main_main_t _enc__oneway_msg__assertFalse_Main_main_t;
...
struct _enc__fut_msg__assertFalse_Main_init_t
{
  encore_fut_msg_t ;
};


struct _enc__oneway_msg__assertFalse_Main_init_t
{
  encore_oneway_msg_t msg;
};


struct _enc__fut_msg__assertFalse_Main_await_t
{
  encore_fut_msg_t ;
  future_t* f1 /* f */;
...
struct _enc__oneway_msg__assertFalse_Main_await_t
{
  encore_oneway_msg_t msg;
  future_t* f1 /* f */;
  pony_type_t* _enc__type__t /* _enc__type__t */;
...
struct _enc__fut_msg__assertFalse_Main_suspend_t
{
  encore_fut_msg_t ;
};


struct _enc__oneway_msg__assertFalse_Main_suspend_t
{
  encore_oneway_msg_t msg;
};


struct _enc__fut_msg__assertFalse_Main_main_t
{
  encore_fut_msg_t ;
};


struct _enc__oneway_msg__assertFalse_Main_main_t
{
  encore_oneway_msg_t msg;
};
...
void _enc__trace__assertFalse_Main(pony_ctx_t*, void*);
...
void _enc__type_init__assertFalse_Main(_enc__active__assertFalse_Main_t*, ...);
...
void* _enc__method__assertFalse_Main_init(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


void* _enc__method__assertFalse_Main_await(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, future_t*);


void* _enc__method__assertFalse_Main_suspend(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


void* _enc__method__assertFalse_Main_main(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, array_t*);
...
future_t* _enc__method__assertFalse_Main_init_future(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


future_t* _enc__method__assertFalse_Main_await_future(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, future_t*);


future_t* _enc__method__assertFalse_Main_suspend_future(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


future_t* _enc__method__assertFalse_Main_main_future(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


void _enc__method__assertFalse_Main_init_one_way(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


void _enc__method__assertFalse_Main_await_one_way(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, future_t*);


void _enc__method__assertFalse_Main_suspend_one_way(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


void _enc__method__assertFalse_Main_main_one_way(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**);


future_t* _enc__method__assertFalse_Main_init_forward(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, future_t*);


future_t* _enc__method__assertFalse_Main_await_forward(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, future_t*, future_t*);


future_t* _enc__method__assertFalse_Main_suspend_forward(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, future_t*);


future_t* _enc__method__assertFalse_Main_main_forward(pony_ctx_t**, _enc__active__assertFalse_Main_t*, pony_type_t**, future_t*);
...
_enc__active__assertFalse_Main_t* _enc__constructor__assertFalse_Main();
