...
void _enc__type_init_String_String(_enc__read_String_String_t* _this, ... )
{
  va_list params;
...
void _enc__trace_String_String(pony_ctx_t* _ctx_arg, void* p)
{
  ...
  _enc__read_String_String_t* _this = p;
...
_enc__read_String_String_t* _enc__constructor_String_String(pony_ctx_t** _ctx, pony_type_t** runtimeType)
{
  _enc__read_String_String_t* _this = ((_enc__read_String_String_t*) encore_alloc((*_ctx), sizeof(_enc__read_String_String_t)));
  _this->_enc__self_type = (&(_enc__read_String_String_type));
  return _this;
}


option_t* _enc__method_String_String_to_int(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
...
array_t* _enc__method_String_String_split(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_p)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "split");
  /* occurrences = this.occurrences(p) */;
  check_receiver(_this, ".", "this", "occurrences", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 388, column 21)");
  pony_type_t* _tmp_1[] = {};
  ...
  check_receiver(_enc__arg_p, ".", "p", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 389, column 21)");
  pony_type_t* _tmp_5[] = {};
  ...
  {
    array_t* _array_11 = array_mk(_ctx, 1, (&(_enc__read_String_String_type)));
  ...
  else
  {
    ...
    if (({int64_t _binop_14 = (({ _pattern_len_7;}) == ({int64_t _literal_13 = 0; _literal_13;})); _binop_14;}))
    {
      ...
      check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 394, column 34)");
      pony_type_t* _tmp_17[] = {};
      int64_t _sync_method_call_16 = _enc__method_String_String_length(_ctx, _this, NULL);
      array_t* _array_15 = array_mk(_ctx, _sync_method_call_16, (&(_enc__read_String_String_type)));
  ...
  s_arr(i) = string_from_char(match this.char_at(i) with
      ...
      while (((_index_21 >= _literal_27) && (_index_21 <= _binop_30)))
      {
        ...
        check_receiver(_this, ".", "this", "char_at", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 396, column 47)");
        pony_type_t* _tmp_35[] = {};
        ...
        pony_type_t* _tmp_41[] = {};
        _enc__read_String_String_t* _fun_call_42 = _enc__global_fun_Stringstring_from_char(_ctx, NULL, _match_33);
    ...
    else
    {
      ...
      array_t* _array_43 = array_mk(_ctx, _binop_45, (&(_enc__read_String_String_type)));
  ...
  start = stop + pattern_len
        ...
        /* stop = this.find_from(p, start) */;
        check_receiver(_this, ".", "this", "find_from", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 407, column 18)");
        pony_type_t* _tmp_67[] = {};
        ...
        check_receiver(_this, ".", "this", "substring", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 408, column 29)");
        pony_type_t* _tmp_70[] = {};
        option_t* _sync_method_call_69 = _enc__method_String_String_substring(_ctx, _this, NULL, _start_50, _stop_53);
        _enc__read_String_String_t* _match_68;
        _enc__read_String_String_t* _s_71;
        if ((({int64_t _optionCheck_73;
               _optionCheck_73 = ((JUST == (*_sync_method_call_69).tag) && ({int64_t _varBinding_74;
                                                                             _enc__read_String_String_t* _optionVal_72 = (*_sync_method_call_69).val.p;
                                                                             _s_71 = _optionVal_72;
                                                                             _varBinding_74 = 1; _varBinding_74;})); _optionCheck_73;}) && ({int64_t _literal_75 = 1/*True*/; _literal_75;})))
        {
          _match_68 = ((_enc__read_String_String_t*) ({ _s_71;}));
        }
        else
        {
          fprintf(stderr, "*** Runtime error: No matching clause was found ***\n");
      ...
      check_receiver(_this, ".", "this", "substring", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 413, column 37)");
      check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 413, column 59)");
      pony_type_t* _tmp_81[] = {};
...
array_t* _enc__method_String_String_to_array(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "to_array");
  /* len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 372, column 13)");
  pony_type_t* _tmp_1[] = {};
  ...
  while (((_index_8 >= _literal_14) && (_index_8 <= _binop_16)))
  {
    ...
    check_receiver(_this, ".", "this", "char_at", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 376, column 24)");
    pony_type_t* _tmp_21[] = {};
...
option_t* _enc__method_String_String_char_at(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, int64_t _enc__arg_i)
{
  ...
  char* _s_2 = _fieldacc_0;
  /* len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 360, column 13)");
  pony_type_t* _tmp_4[] = {};
...
_enc__read_String_String_t* _enc__method_String_String_format(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, array_t* _enc__arg_b)
{
...
_enc__read_String_String_t* _enc__method_String_String_delete(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_s)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "delete");
  /* to_len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 321, column 16)");
  pony_type_t* _tmp_1[] = {};
  int64_t _sync_method_call_0 = _enc__method_String_String_length(_ctx, _this, NULL);
  int64_t _to_len_3 = _sync_method_call_0;
  /* s_len = s.length() */;
  check_receiver(_enc__arg_s, ".", "s", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 322, column 15)");
  pony_type_t* _tmp_5[] = {};
  int64_t _sync_method_call_4 = _enc__method_String_String_length(_ctx, _enc__arg_s, NULL);
  int64_t _s_len_7 = _sync_method_call_4;
  _enc__read_String_String_t* _new_8 = _enc__constructor_String_String(_ctx, NULL);
  ...
  return ((_enc__read_String_String_t*) _new_8);
}


int64_t _enc__method_String_String_find_from(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_a, int64_t _enc__arg_b)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "find_from");
  int64_t _ite_0;
  if (({int64_t _binop_6 = (({int64_t _binop_2 = (({ _enc__arg_b;}) < ({int64_t _literal_1 = 0; _literal_1;})); _binop_2;}) || ({int64_t _binop_5 = (({ _enc__arg_b;}) >= ({check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 306, column 25)");
                                                                                                                                                                            pony_type_t* _tmp_4[] = {};
...
int64_t _enc__method_String_String_find(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_a)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "find");
  check_receiver(_this, ".", "this", "find_from", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 300, column 5)");
...
_enc__read_String_String_t* _enc__method_String_String_replace(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_a, _enc__read_String_String_t* _enc__arg_b)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "replace");
  check_receiver(_enc__arg_b, ".", "b", "join", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 294, column 5)");
  check_receiver(_this, ".", "this", "split", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 294, column 12)");
  pony_type_t* _tmp_2[] = {};
  array_t* _sync_method_call_1 = _enc__method_String_String_split(_ctx, _this, NULL, _enc__arg_a);
  pony_type_t* _tmp_3[] = {};
  _enc__read_String_String_t* _sync_method_call_0 = _enc__method_String_String_join(_ctx, _enc__arg_b, NULL, _sync_method_call_1);
  ENC_DTRACE3(METHOD_EXIT, (uintptr_t)*_ctx, (uintptr_t)_this, "replace");
  return ((_enc__read_String_String_t*) _sync_method_call_0);
}


_enc__read_String_String_t* _enc__method_String_String_trim(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "trim");
  /* len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 279, column 13)");
  pony_type_t* _tmp_1[] = {};
  int64_t _sync_method_call_0 = _enc__method_String_String_length(_ctx, _this, NULL);
  int64_t _len_3 = _sync_method_call_0;
  /* str = this.data */;
...
END */;
  ...
  check_receiver(_this, ".", "this", "substring", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 284, column 13)");
  ...
  return ((_enc__read_String_String_t*) _match_13);
}


char* _enc__method_String_String_getData(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
...
_enc__read_String_String_t* _enc__method_String_String_join(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, array_t* _enc__arg_strings)
{
  ...
  else
  {
    ...
    _enc__read_String_String_t* _access_8 = array_get(_enc__arg_strings, _literal_7).p;
    _enc__read_String_String_t* _result_10 = _access_8;
  ...
  result = result.concatenate(this).concatenate(strings(i))
    ...
    while (((_index_12 >= _literal_18) && (_index_12 <= _binop_21)))
    {
      ...
      check_receiver(_result_10, ".", "result", "concatenate", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 265, column 18)");
      pony_type_t* _tmp_26[] = {};
      _enc__read_String_String_t* _sync_method_call_25 = _enc__method_String_String_concatenate(_ctx, _result_10, NULL, _this);
      check_receiver(_sync_method_call_25, ".", "result.concatenate(this)", "concatenate", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 265, column 18)");
      _enc__read_String_String_t* _access_27 = array_get(_enc__arg_strings, _i_13).p;
      pony_type_t* _tmp_28[] = {};
      _enc__read_String_String_t* _sync_method_call_24 = _enc__method_String_String_concatenate(_ctx, _sync_method_call_25, NULL, _access_27);
      _result_10 = _sync_method_call_24;
      _for_11 = UNIT;
      _index_12 = (_index_12 + _step_16);
    };
    /* result */;
    _ite_0 = ((_enc__read_String_String_t*) _result_10);
  };
...
int64_t _enc__method_String_String_occurrences(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_s)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "occurrences");
  int64_t _ite_0;
  if (({int64_t _binop_4 = (({check_receiver(_enc__arg_s, ".", "s", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 241, column 8)");
                              pony_type_t* _tmp_2[] = {};
  ...
  {
    check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 242, column 7)");
    pony_type_t* _tmp_6[] = {};
  ...
  else
  {
    ...
    /* var i = this.find(s) */;
    /* i = this.find(s) */;
    check_receiver(_this, ".", "this", "find", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 245, column 21)");
    pony_type_t* _tmp_11[] = {};
    ...
    /* val s_len = s.length() */;
    /* s_len = s.length() */;
    check_receiver(_enc__arg_s, ".", "s", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 246, column 21)");
    pony_type_t* _tmp_15[] = {};
  ...
  i = this.find_from(s, i + s_len)
    ...
    while (({int64_t _binop_19 = (({ _i_13;}) >= ({int64_t _literal_18 = 0; _literal_18;})); _binop_19;}))
    {
      ...
      /* i = this.find_from(s, i + s_len) */;
      check_receiver(_this, ".", "this", "find_from", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 249, column 13)");
...
int64_t _enc__method_String_String_eq(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_s)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "eq");
  int64_t _binop_3 = (({check_receiver(_this, ".", "this", "compare", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 236, column 5)");
                        pony_type_t* _tmp_1[] = {};
...
int64_t _enc__method_String_String_equals(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_s)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "equals");
  check_receiver(_this, ".", "this", "eq", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 231, column 5)");
  pony_type_t* _tmp_1[] = {};
...
option_t* _enc__method_String_String_substring(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, int64_t _enc__arg_from, int64_t _enc__arg_to)
{
  ...
  {
    _enc__read_String_String_t* _new_2 = _enc__constructor_String_String(_ctx, NULL);
    char* _embed_3 = ({"";});
    pony_type_t* _tmp_4[] = {};
    _enc__type_init_String_String(_new_2);
    _enc__method_String_String_init(_ctx, _new_2, NULL, _embed_3);
    option_t* _option_5 = option_mk(_ctx, JUST, ((encore_arg_t) {.p = _new_2}), (&(_enc__read_String_String_type)));
    _ite_0 = ((option_t*) _option_5);
  }
  else
  {
    /* t_len = this.length() */;
    check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 210, column 17)");
    pony_type_t* _tmp_7[] = {};
    ...
    if (({int64_t _binop_15 = (({ _enc__arg_from;}) >= ({int64_t _literal_14 = 0; _literal_14;})); _binop_15;}))
    {
      ...
      option_t* _option_19 = option_mk(_ctx, JUST, ((encore_arg_t) {.p = _new_16}), (&(_enc__read_String_String_type)));
...
int64_t _enc__method_String_String_size(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
...
int64_t _enc__method_String_String_length(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
...
_enc__read_String_String_t* _enc__method_String_String_to_lower(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "to_lower");
  /* t_len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 178, column 15)");
  pony_type_t* _tmp_1[] = {};
  int64_t _sync_method_call_0 = _enc__method_String_String_length(_ctx, _this, NULL);
  ...
  _enc__read_String_String_t* _new_7 = _enc__constructor_String_String(_ctx, NULL);
  ...
  return ((_enc__read_String_String_t*) _new_7);
}


_enc__read_String_String_t* _enc__method_String_String_to_upper(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "to_upper");
  /* t_len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 160, column 15)");
  pony_type_t* _tmp_1[] = {};
  int64_t _sync_method_call_0 = _enc__method_String_String_length(_ctx, _this, NULL);
  int64_t _t_len_3 = _sync_method_call_0;
  /* data = this.data */;
...
int64_t _enc__method_String_String_compare_ignore_case(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_b)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "compare_ignore_case");
  check_receiver(_this, ".", "this", "to_upper", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 154, column 5)");
  pony_type_t* _tmp_2[] = {};
  _enc__read_String_String_t* _sync_method_call_1 = _enc__method_String_String_to_upper(_ctx, _this, NULL);
  check_receiver(_sync_method_call_1, ".", "this.to_upper()", "compare", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 154, column 5)");
  check_receiver(_enc__arg_b, ".", "b", "to_upper", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 154, column 29)");
  pony_type_t* _tmp_4[] = {};
  _enc__read_String_String_t* _sync_method_call_3 = _enc__method_String_String_to_upper(_ctx, _enc__arg_b, NULL);
  pony_type_t* _tmp_5[] = {};
...
int64_t _enc__method_String_String_compare(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_b)
{
...
int64_t _enc__method_String_String_contains_ignore_case(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_b)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "contains_ignore_case");
  check_receiver(_this, ".", "this", "to_upper", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 136, column 5)");
  pony_type_t* _tmp_2[] = {};
  _enc__read_String_String_t* _sync_method_call_1 = _enc__method_String_String_to_upper(_ctx, _this, NULL);
  check_receiver(_sync_method_call_1, ".", "this.to_upper()", "contains", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 136, column 5)");
  check_receiver(_enc__arg_b, ".", "b", "to_upper", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 136, column 30)");
  pony_type_t* _tmp_4[] = {};
  _enc__read_String_String_t* _sync_method_call_3 = _enc__method_String_String_to_upper(_ctx, _enc__arg_b, NULL);
  pony_type_t* _tmp_5[] = {};
...
int64_t _enc__method_String_String_contains(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_b)
{
...
_enc__read_String_String_t* _enc__method_String_String_copy(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "copy");
  /* t_len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 112, column 15)");
  pony_type_t* _tmp_1[] = {};
  int64_t _sync_method_call_0 = _enc__method_String_String_length(_ctx, _this, NULL);
  int64_t _t_len_3 = _sync_method_call_0;
  /* data = this.data */;
...
_enc__read_String_String_t* _enc__method_String_String_concatenate(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, _enc__read_String_String_t* _enc__arg_b)
{
  ENC_DTRACE3(METHOD_ENTRY, (uintptr_t)*_ctx, (uintptr_t)_this, "concatenate");
  /* t_len = this.length() */;
  check_receiver(_this, ".", "this", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 95, column 16)");
  pony_type_t* _tmp_1[] = {};
  int64_t _sync_method_call_0 = _enc__method_String_String_length(_ctx, _this, NULL);
  int64_t _t_len_3 = _sync_method_call_0;
  /* b_len = b.length() */;
  check_receiver(_enc__arg_b, ".", "b", "length", "\"/Users/Kattas/chainless_mono_proto_encore_01_embedded/encore/modules/standard/String.enc\" (line 96, column 16)");
  pony_type_t* _tmp_5[] = {};
  ...
  _enc__read_String_String_t* _new_14 = _enc__constructor_String_String(_ctx, NULL);
  ...
  return ((_enc__read_String_String_t*) _new_14);
}


int64_t _enc__method_String_String_is_empty(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType)
{
...
void* _enc__method_String_String_init(pony_ctx_t** _ctx, _enc__read_String_String_t* _this, pony_type_t** runtimeType, char* _enc__arg_s)
{
...
pony_type_t _enc__read_String_String_type = {.id=_ENC__ID_String_String, .size=sizeof(_enc__read_String_String_t), .trace=_enc__trace_String_String, .vtable=trait_method_selector};
