...
void* _enc__method__forwardFieldAccess_Main_main(pony_ctx_t** _ctx, _enc__class__forwardFieldAccess_Main_t* _this, pony_type_t** runtimeType, array_t* _argv)
{
  ...
  check_receiver(_this, ".", "this", "init", "\"forwardFieldAccess.enc\" (line 24, column 5)");
  pony_type_t* _tmp_1[] = {};
  void* _sync_method_call_0 = _enc__method__forwardFieldAccess_Main_init(_ctx, _this, NULL);
  /* do
  val bar = (new Bar)!bar()
  val foo = new Foo(bar)
  println("{}", get(foo!foo_arg()))
  ...
  /* val bar = (new Bar)!bar() */;
  /* bar = (new Bar)!bar() */;
  _enc__class__forwardFieldAccess_Bar_t* _new_2 = _enc__constructor__forwardFieldAccess_Bar(_ctx, NULL);
  pony_type_t* _tmp_3[] = {};
  _enc__type_init__forwardFieldAccess_Bar(_new_2);
  _enc__method__forwardFieldAccess_Bar_init_one_way(_ctx, _new_2, NULL);
  check_receiver(_new_2, " ! ", "new Bar()", "bar", "\"forwardFieldAccess.enc\" (line 22, column 25)");
  pony_type_t* _tmp_4[] = {};
  future_t* _fut_5 = _enc__method__forwardFieldAccess_Bar_bar_future(_ctx, _new_2, NULL);
  future_t* _bar_7 = _fut_5;
  /* val foo = new Foo(bar) */;
  /* foo = new Foo(bar) */;
  _enc__class__forwardFieldAccess_Foo_t* _new_8 = _enc__constructor__forwardFieldAccess_Foo(_ctx, NULL);
  pony_type_t* _tmp_9[] = {};
  _enc__type_init__forwardFieldAccess_Foo(_new_8);
  _enc__method__forwardFieldAccess_Foo_init_one_way(_ctx, _new_8, NULL, _bar_7);
  _enc__class__forwardFieldAccess_Foo_t* _foo_11 = _new_8;
  /* println("{}", get(foo!foo_arg())) */;
  check_receiver(_foo_11, " ! ", "foo", "foo_arg", "\"forwardFieldAccess.enc\" (line 24, column 27)");
  pony_type_t* _tmp_12[] = {};
  future_t* _fut_13 = _enc__method__forwardFieldAccess_Foo_foo_arg_future(_ctx, _foo_11, NULL);
  int64_t _tmp_14 = future_get_actor(_ctx, _fut_13).i;
  fprintf(stdout, "%lli\n", _tmp_14);
